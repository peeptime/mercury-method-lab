...
|---|---|---|---|---|---|
| 2026-05-12 | `v2.0.2` Admission Contract | declined | project_owner_pending | Admission Contract separates source material, Mercury framing, user judgment, and admitted memory object, but the object taxonomy and usage policy defaults are AI-assisted reference defaults. | Project owner should test whether the contract language matches real user decisions before treating it as canonical protocol. |
| 2026-05-12 | `v2.0.1` Admission Reframe | declined | project_owner_pending | Public naming is narrowed to Mercury Admission Lab and the README now foregrounds lack of external validation, lack of precision/recall, lack of cross-model certification, multi-agent contamination risk, and missing human trust anchor. This is still an AI-assisted framing pass, not human approval. | Project owner should review the new name and roadmap before treating them as canonical public positioning. |
| 2026-05-10 | `v1.9.0` Proof Governance Expansion | declined | project_owner_pending | Proof Pack 002 and governance modules expand coverage into multi-agent, stale memory, code, chart, reviewer disagreement, and audit gaming cases, but the new cases and detectors are AI-assisted reference artifacts. | Project owner should review the six new cases and anti-gaming patterns before treating them as canonical policy. |
| 2026-05-10 | `v1.8.0` Open Scenario Packs | declined | project_owner_pending | Scenario packs make the kernel more portable across AI coding, personal knowledge, investment research, enterprise delivery, and legal/medical risk, but the templates are AI-assisted starting points. | Validate each scenario with real users or domain reviewers before treating it as canonical. |
