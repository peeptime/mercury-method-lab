...
- Current public version: `2.0.0-alpha.3`
- Current posture: Evidence Chain Interface
...
- Use `v2.0.0` next for performance optimization and lightweight Mercury skills.
